...
1. **Create a Connected App for the New SP Org**:
   ...
   - Ensurte the connected app is available to the required profile(s) (e.g. System Administrator)
...
2. **Enable SSO Settings**:
   ...
   - Check the Federation Id of the user - It needs to be same for both orgs.
